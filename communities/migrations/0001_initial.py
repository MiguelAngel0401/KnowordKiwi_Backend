# Generated by Django 5.2.3 on 2025-06-23 20:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='members', to='communities.communityrole')),
            ],
            options={
                'verbose_name': 'Miembro de la comunidad',
                'verbose_name_plural': 'Miembros de comunidades',
                'db_table': 'community_members',
                'indexes': [models.Index(fields=['community', 'user'], name='community_m_communi_973737_idx')],
